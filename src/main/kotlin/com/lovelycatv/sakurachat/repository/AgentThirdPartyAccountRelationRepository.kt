...
import com.lovelycatv.sakurachat.entity.AgentThirdPartyAccountRelationEntity
...
interface AgentThirdPartyAccountRelationRepository : JpaRepository<AgentThirdPartyAccountRelationEntity, AgentThirdPartyAccountRelationEntity.PrimaryKey> {
    ...
    fun findByChannelId(@Param("thirdPartyAccountId") thirdPartyAccountId: Long): List<AgentThirdPartyAccountRelationEntity>
}